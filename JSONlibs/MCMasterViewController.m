...
- (void)viewDidLoad
{
    ...
    _libraries = [[NSArray alloc] initWithObjects:@"JSONKit", @"JSONKitData", @"JSONKitThread", @"JSONKitDataThread", @"TouchJSON", @"NextiveJson", @"SBJson", @"SBJsonData", @"NSJSONSerialization", nil];
